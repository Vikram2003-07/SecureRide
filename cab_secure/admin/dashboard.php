...
// ✅ SECURITY: Require Admin Authentication (Role-Based Access Control)
require_admin();
...
<body>
    ...
    <div class="container mt-4">
        ...
        <p class="text-muted">Welcome, <?php echo htmlspecialchars($_SESSION['admin_username']); ?></p>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <small>
                                                <?php echo htmlspecialchars(substr($booking['pickup_location'], 0, 20)); ?>... → 
                                                <?php echo htmlspecialchars(substr($booking['dropoff_location'], 0, 20)); ?>...
                                            </small>
                                        </td>
        ...
        <div class="alert alert-success mt-4">
            <i class="fas fa-shield-alt"></i> <strong>Role-Based Access:</strong>
